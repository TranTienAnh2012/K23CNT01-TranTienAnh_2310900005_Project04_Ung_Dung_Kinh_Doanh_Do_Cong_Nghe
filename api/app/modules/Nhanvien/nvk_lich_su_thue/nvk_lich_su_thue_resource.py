...
from app.modules.Nhanvien.nvk_lich_su_thue import nvk_lich_su_thue_service as service
...
class LichSuThueListResource(Resource):
    @jwt_required()
    @staff_required
    def get(self):
...
class LichSuThueResource(Resource):
    @jwt_required()
    @staff_required
    def get(self, id):
