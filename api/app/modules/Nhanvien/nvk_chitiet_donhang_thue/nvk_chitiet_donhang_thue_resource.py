...
from app.modules.Nhanvien.nvk_chitiet_donhang_thue import nvk_chitiet_donhang_thue_service as service
...
class ChiTietDonHangThueListResource(Resource):
    @jwt_required()
    @staff_required
    def get(self):
...
class ChiTietDonHangThueResource(Resource):
    @jwt_required()
    @staff_required
    def get(self, id):
