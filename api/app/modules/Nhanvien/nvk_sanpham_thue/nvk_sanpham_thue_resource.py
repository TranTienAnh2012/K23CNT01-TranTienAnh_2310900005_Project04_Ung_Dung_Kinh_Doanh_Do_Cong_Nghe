...
from app.modules.Nhanvien.nvk_sanpham_thue import nvk_sanpham_thue_service as service
...
class SanPhamThueListResource(Resource):
    @jwt_required()
    @staff_required
    def get(self):
...
class SanPhamThueResource(Resource):
    @jwt_required()
    @staff_required
    def get(self, id):
