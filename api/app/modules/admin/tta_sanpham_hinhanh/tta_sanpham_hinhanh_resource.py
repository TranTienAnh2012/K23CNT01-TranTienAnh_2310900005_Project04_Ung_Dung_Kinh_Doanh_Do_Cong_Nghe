...
from app.modules.admin.tta_sanpham_hinhanh import tta_sanpham_hinhanh_service as service
...
class SanPhamHinhAnhListResource(Resource):
    @jwt_required()
    @admin_required
    def get(self):
...
class SanPhamHinhAnhResource(Resource):
    @jwt_required()
    @admin_required
    def get(self, id):
