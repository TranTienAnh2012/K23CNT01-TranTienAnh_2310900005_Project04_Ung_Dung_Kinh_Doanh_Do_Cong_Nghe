  ...
  useEffect(() => {
    const fetchStats = async () => {
      try {
        ...
        // Nếu lỗi, để 0 chứ không dùng data giả gây hiểu lầm
        setStats({
          products: 0,
          users: 0,
          orders: 0,
              ...
              <table className="w-full text-sm text-left border-collapse">
                ...
                <tbody className="text-slate-300">
                  <tr className="border-b border-slate-800/50 hover:bg-white/5 transition-colors">
                    ...
                    <td className="px-6 py-4 text-slate-500">Mới cập nhật</td>
                  </tr>
                  <tr className="border-b border-slate-800/50 hover:bg-white/5 transition-colors">
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3">
                    ...
                    <td className="px-6 py-4 text-slate-500">Vừa xong</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-4 p-3 rounded-lg bg-slate-800/50 border border-slate-700/50">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-slate-400 mt-0.5">Một số sản phẩm cần kiểm tra lại hình ảnh đại diện.</p>
              ...
              <div className="flex items-start gap-4 p-3 rounded-lg bg-slate-800/50 border border-slate-700/50">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-[10px] text-slate-500 mt-2 font-medium">Định kỳ hàng ngày</p>
                </div>
              </div>
              <div className="flex items-start gap-4 p-3 rounded-lg bg-slate-800/50 border border-slate-700/50">
