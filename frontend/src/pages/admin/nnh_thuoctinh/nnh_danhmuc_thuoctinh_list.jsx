...
export default function TtaDanhMucThuocTinhList() {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      setCategories([
        { id: 1, ten_danh_muc: "Điện thoại thông minh", icons: 'smartphone' },
        { id: 2, ten_danh_muc: "Laptop & Phụ kiện", icons: 'laptop_mac' },
        { id: 3, ten_danh_muc: "Thiết bị âm thanh", icons: 'headphones' }
      ]);
      setMappings([
        { Id: 1, MaDanhMuc: 1, TenDanhMuc: "Điện thoại thông minh", TenThuocTinh: "Thương hiệu", MaThuocTinh: "ATTR_BRAND_01", KieuDuLieu: "Dropdown", Required: true, Icon: 'branding_watermark' },
        { Id: 2, MaDanhMuc: 1, TenDanhMuc: "Điện thoại thông minh", TenThuocTinh: "Dung lượng RAM", MaThuocTinh: "ATTR_RAM_02", KieuDuLieu: "Tag Selection", Required: true, Icon: 'memory' },
        { Id: 3, MaDanhMuc: 1, TenDanhMuc: "Điện thoại thông minh", TenThuocTinh: "Màu sắc phiên bản", MaThuocTinh: "ATTR_COLOR_03", KieuDuLieu: "Color Picker", Required: false, Icon: 'palette' },
      ]);
    } finally {
      setLoading(false);
    }
        ...
        <div className="col-span-12 lg:col-span-8 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-slate-900/60 p-5 rounded-2xl border border-slate-800 shadow-lg">
              ...
              <div className="text-2xl font-bold text-white font-['Space_Grotesk']">94%</div>
            ...
            <div className="bg-slate-900/60 p-5 rounded-2xl border border-slate-800 shadow-lg">
              ...
              <div className="text-2xl font-bold text-white font-['Space_Grotesk']">12,482</div>
            </div>
            <div className="bg-slate-900/60 p-5 rounded-2xl border border-slate-800 shadow-lg">
              <div className="flex items-center gap-3 mb-3">
              ...
              <div className="text-2xl font-bold text-white font-['Space_Grotesk']">03</div>
            </div>
          </div>
        </div>
      </div>
