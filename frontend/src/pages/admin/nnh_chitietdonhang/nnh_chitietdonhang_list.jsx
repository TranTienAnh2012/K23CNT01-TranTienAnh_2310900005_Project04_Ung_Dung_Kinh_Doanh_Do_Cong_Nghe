        ...
        items: [
          {
            ...
            MaDonHang: 'ORD-99283',
            MaSanPham: 'PROD-001',
            TenSanPham: 'Zenith Phone 15 Pro',
            BienThe: 'Space Gray / 256GB',
            HinhAnh: 'https://lh3.googleusercontent.com/aida-public/AB6AXuAvxV6Wv5FDSWjt48WrFFG-yKHYQ_m7Dr2oYTjEjXI7ZS0S4kYZZgJvk9z-ZgX0PwdSeDw7QpNAdXH5l8ix07ggzBfe3rT2oQqRQ53-INezNDHxWhexknnwuQlx5agiCkFLIs4m-s7v4RMMHCK2Uy2BtIGnZaTQvZ2jQYnWKtDel13fTuglLopi3XtYGnftU3ktn1EUOVgGZ59_8W2wjV1VMgYmcY3drMX-BO13g3vJUfDc7gIiRXR-Iu3dwvemBDtjaPev38mxiw',
            HoTenNguoiNhan: 'Nguyễn Văn A',
            Email: 'vn.a@zenith.com',
            NgayDatHang: '2023-10-24',
            SoLuong: 1,
            DonGia: 28500000
          },
          {
            ...
            MaDonHang: 'ORD-99283',
            MaSanPham: 'PROD-042',
            TenSanPham: 'Zenith Audio Max',
            BienThe: 'Noise Cancelling',
            HinhAnh: 'https://lh3.googleusercontent.com/aida-public/AB6AXuBgBT6TSyoTCRKJtB7ZLLwpHBccmB7YySDbQ4Kn5ichbPGDmc1jr8kox6ByVr_hSrsYhE5eBqU246q7LDnQ5ONTP1i3wcR2-HSc7STPpMooy4yUdDW0ByAgzUIygXhfnSenhhD4Yi8fq2jzxhtWSBRHeM6hzqQXV8eYtlIdFPfJzrzAn1F4L_LeZ5781vobEBXggYqssh3CcF0rpVUp2DvOhVs2w6mrwdtzMR9aPfxblL9EBy3-iahWuHYoHx1PB7IrechsS_-jYA',
            HoTenNguoiNhan: 'Nguyễn Văn A',
            Email: 'vn.a@zenith.com',
            NgayDatHang: '2023-10-24',
            SoLuong: 1,
          ...
          },
          {
            ...
            MaDonHang: 'ORD-99283',
            MaSanPham: 'PROD-015',
            TenSanPham: 'Zenith GaN 65W',
            BienThe: 'Quick Charge Pro',
            HinhAnh: 'https://lh3.googleusercontent.com/aida-public/AB6AXuBwrumUhzuZnYHqsiRRLCneLmB19vGgAlyN3Mw-16d_1bfo-DCq9TQNNMCO2ZruvObLjaXuFuimvmHY51VgI490wICSbgCT0ni5xUW97cu7VlMC-E0phu7R1a118zMyF1Qnxs0BbAz5MYgb_FiZl0Vm2xJ4_Ca22gH7HsnvRPFjwhuR343B8rF2AozyITVDBPuILZvFJTmc0W2fwkkpGwgCMf44_cSmzUfhw7MktGY7S6UG0BXpd9xzAZxCKyPsGVErKRooz1EnSw',
            HoTenNguoiNhan: 'Nguyễn Văn A',
            Email: 'vn.a@zenith.com',
            NgayDatHang: '2023-10-24',
            SoLuong: 1,
    ...
    <div className="p-8 min-h-[calc(100vh-64px)] bg-slate-950 font-['Inter'] space-y-8">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div className="space-y-1">
          ...
          <h3 className="font-['Space_Grotesk'] text-white text-4xl font-bold">#ORD-99283-ZX</h3>
          <p className="text-slate-500 font-medium italic">Viewing granular item breakdown for localized fulfillment center.</p>
        </div>
