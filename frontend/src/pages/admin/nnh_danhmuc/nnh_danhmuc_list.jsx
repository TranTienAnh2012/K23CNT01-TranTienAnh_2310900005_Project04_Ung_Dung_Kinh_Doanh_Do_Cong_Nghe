  ...
  const fetchCategories = async () => {
    ...
    try {
      ...
      setCategories([
        { 
          MaDanhMuc: 1, 
          TenDanhMuc: 'Smartphones', 
          MoTa: 'Cutting-edge mobile devices with 5G and neural processing.',
          ProductCount: 432
        },
        { 
          MaDanhMuc: 2, 
          TenDanhMuc: 'Computing', 
          MoTa: 'High-performance workstations and ultraportable laptops.',
          ProductCount: 128
        },
        { 
          MaDanhMuc: 3, 
          TenDanhMuc: 'Wearables', 
          MoTa: 'Biometric sensors and smart health tracking units.',
          ProductCount: 84
        },
        { 
          MaDanhMuc: 4, 
          TenDanhMuc: 'Audio', 
          MoTa: 'Premium sound systems and noise-canceling headphones.',
          ProductCount: 192
        }
      ]);
    } finally {
      ...
      <div className="max-w-7xl mx-auto w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-10">
          <div className="bg-slate-900/50 backdrop-blur-md border border-slate-800/80 p-6 rounded-2xl">
            ...
            <div className="text-4xl font-['Space_Grotesk'] font-bold text-white">14</div>
          </div>
          <div className="bg-slate-900/50 backdrop-blur-md border border-slate-800/80 p-6 rounded-2xl">
            <div className="flex items-center justify-between mb-4">
