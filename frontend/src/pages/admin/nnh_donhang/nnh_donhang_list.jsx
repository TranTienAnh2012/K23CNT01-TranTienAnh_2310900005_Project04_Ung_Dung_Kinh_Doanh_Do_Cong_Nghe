    ...
    try {
      ...
      setData({
        ...
        orders: [
          ...
          {
            MaDonHang: 'ORD-9419',
            HoTenNguoiNhan: 'Trần Hoa',
            Email: 'hoa.tran@gmail.com',
            SoDienThoai: '0912345678',
            TongTien: 2100000,
            NgayDatHang: '2023-10-23',
            TrangThai: 'Cancelled'
          },
          {
            MaDonHang: 'ORD-9418',
            HoTenNguoiNhan: 'Phạm Vũ',
            Email: 'vu.pham@tech.co',
    ...
    <div className="p-8 min-h-[calc(100vh-64px)] bg-slate-950 font-['Inter']">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
        ...
        <div className="bg-slate-900/60 backdrop-blur-md p-6 rounded-2xl border border-white/5 relative overflow-hidden group">
          ...
          <p className="font-['Space_Grotesk'] text-white text-3xl font-bold">{formatPrice(42890000)}</p>
        </div>
        ...
        <div className="bg-slate-900/60 backdrop-blur-md p-6 rounded-2xl border border-white/5 relative overflow-hidden group">
          ...
          <p className="font-['Space_Grotesk'] text-white text-3xl font-bold">42</p>
        </div>
      </div>
